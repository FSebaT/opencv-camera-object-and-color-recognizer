"""
En este código ya se implementa el uso de un servomotor como parte del proyecto general
...
pwm.start(7.5)  # Iniciar en 90 grados
...
while True:
  ...
  # Control del servomotor según el color detectado
    if closest_color == "red":
        pwm.ChangeDutyCycle(10.0)  # Gira a 180 grados
    elif closest_color == "green":
        pwm.ChangeDutyCycle(5.0)   # Gira a 0 grados
    else:
        pwm.ChangeDutyCycle(7.5)   # Mantén en 90 grados
